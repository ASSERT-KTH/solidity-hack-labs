...
describe('attack access_control/incorrect_constructor_name2.sol', function () {
  let owner;
    async function deployContracts() {
      ...
      const codePath = path.join(__dirname, '../../artifacts/contracts/dataset/access_control/incorrect_constructor_name2.sol/Missing.json');
      ...
      const MissingAttacker = await ethers.getContractFactory('contracts/access_control/incorrect_constructor_name2_attack.sol:MissingAttacker');
