...
describe("Reentrancy Attack for reentrance.sol", function () {  
    ...
    beforeEach(async function () {
        ...
        const codePath = path.join(__dirname, '../../artifacts/contracts/dataset/reentrancy/reentrance.sol/Reentrance.json');
    ...
    it('sanity check: reentrancy/reentrance.sol', async function () {
        await expect(victim.donate(victim.target, {value:0})).to.not.be.reverted;
    });
